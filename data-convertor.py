...
#Q4
#query = "CREATE TABLE top_N_products_by_date (review_date DATE, product_id VARCHAR, reviews_amount INT, product_title VARCHAR, PRIMARY KEY ((review_date), reviews_amount, product_id)) WITH CLUSTERING ORDER BY (reviews_amount DESC)"

#Q5
#query = "CREATE TABLE top_N_customers_by_date (review_date DATE, customer_id INT, reviews_amount INT, PRIMARY KEY ((review_date), reviews_amount, customer_id)) WITH CLUSTERING ORDER BY (reviews_amount DESC)"

#Q7
#query = "CREATE TABLE top_N_haters_by_date (review_date DATE, customer_id INT, bad_reviews_amount INT, PRIMARY KEY ((review_date), bad_reviews_amount, customer_id)) WITH CLUSTERING ORDER BY (bad_reviews_amount DESC)"

#Q8
#query = "CREATE TABLE top_N_backers_by_date (review_date DATE, customer_id INT, good_reviews_amount INT, PRIMARY KEY ((review_date), good_reviews_amount, customer_id)) WITH CLUSTERING ORDER BY (good_reviews_amount DESC)"